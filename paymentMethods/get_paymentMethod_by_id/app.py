...
def lambda_handler(event, context):
    ...
    error_500 = {
        ...
        "headers": cors_headers,
        "body": json.dumps({
            "error": "Internal Error - Payment Method Not Found"
        })
    }
...
def get_paymentMethod_by_id(id_payment_method):
    db = DatabaseConfig()
    ...
    try:
        with connection.cursor() as cursor:
            ...
            cursor.execute(get_query, id_payment_method)
