...
def lambda_handler(event, context):
    ...
    error_500 = {
        ...
        "headers": cors_headers,
        "body": json.dumps({
            "error": "Internal Error - Payment Method Not Deleted"
        })
    }
    ...
    try:
        ...
        return delete_paymentMethod_by_id(id_paymentMethod)
...
def delete_paymentMethod_by_id(id_paymentMethod):
    db = DatabaseConfig()
    ...
    try:
        with connection.cursor() as cursor:
            ...
            if len(result) > 0:
                ...
                cursor.execute(delete_query, id_paymentMethod)
                connection.commit()
                return {
                    "statusCode": 200,
                    "headers": cors_headers,
