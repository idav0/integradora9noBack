...
def lambda_handler(event, context):
    ...
    try:
        ...
        return update_user_data_patch(username, temp_password, new_password)
...
def update_user_data_patch(username, temp_password, new_password):
    db = DatabaseConfig()
    ...
    try:
        with connection.cursor() as cursor:
            ...
            if len(result_username) > 0:
                ...
                confirm_old_password = temp_password == user['password']
