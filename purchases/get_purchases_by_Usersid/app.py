...
def lambda_handler(event, context):
    ...
    try:
        ...
        id_user = event['pathParameters'].get('id_user')
        ...
        return get_purchase_by_id(id_user)
...
def get_purchase_by_id(id_user):
    db = DatabaseConfig()
    ...
    try:
        with connection.cursor() as cursor:
            get_query = ("SELECT p.id "
                         ...
                         "JOIN Products pr ON pp.Products_id = pr.id WHERE Users_id = %s")
