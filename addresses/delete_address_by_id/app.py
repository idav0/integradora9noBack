...
def lambda_handler(event, context):
    ...
    error_500 = {
        ...
        "headers": cors_headers,
        "body": json.dumps({
            "error": "Internal Error - Address Not Deleted"
        })
    }
    ...
    try:
        ...
        return delete_address_by_id(id_address)
...
def delete_address_by_id(id_address):
    db = DatabaseConfig()
    ...
    try:
        with connection.cursor() as cursor:
            ...
            if len(result) > 0:
                ...
                cursor.execute(delete_query, id_address)
                connection.commit()
                return {
                    "statusCode": 200,
                    "headers": cors_headers,
